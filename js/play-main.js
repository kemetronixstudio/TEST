...
(function(){
  ...
  function getStageFromGrade(grade){ const g = String(grade || '').toLowerCase().replace(/\s+/g,''); if (g === 'kg1' || g === 'kg2' || g === 'grade1' || g === 'grade2') return 'starter'; if (g === 'grade3' || g === 'grade4') return 'explorer'; return 'champion'; }
